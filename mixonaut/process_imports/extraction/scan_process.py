...
from process_imports.extraction.copy_extract_service import CopyExtractService
from utils.config import MUSIC_SOURCE_PATH, MUSIC_IMPORT_PATH
from utils.logger import with_child_logger

@with_child_logger
def scan_and_process_downloads(nb_limit: int, source_root: Path=MUSIC_SOURCE_PATH, imports_root: Path=MUSIC_IMPORT_PATH,  logger=None):
    """
