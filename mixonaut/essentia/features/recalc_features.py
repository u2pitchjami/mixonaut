from db.analyse.essentia_queries import get_audio_features_by_id, insert_or_update_audio_features
from db.beets.db_beets_queries import get_item_field_value, retro_inject_features
from essentia.features.essentia_calculate import calculate_beat_intensity
from essentia.features.essentia_mood import compute_mood_vector, get_dominant_mood
from essentia.features.essentia_key import get_best_key_from_essentia, convert_to_camelot
from essentia.features.essentia_genre import get_dominant_genre
from process_analyse.transposition.transposition import generate_transpositions
from process_analyse.retro_beets.write_tags import write_tags_docker
