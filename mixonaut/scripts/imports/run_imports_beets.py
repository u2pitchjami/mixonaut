...
from beets_utils.commands.imports import import_auto, import_manuel
from process_imports.extraction.scan_process import scan_and_process_downloads
from process_imports.post_imports.process_successful_imports import process_successful_imports
from process_imports.qbit.process_qbit import import_completed_torrents
from process_imports.beets.beets_manual_extract import extract_manual_imports_and_decisions
...
def main(source_dir=MUSIC_SOURCE_PATH, import_dir=MUSIC_IMPORT_PATH, nb_limit="0", manuel=False, noincremental=False, noscan=False):
    ...
    if not noscan:
        ...
        scan_and_process_downloads(nb_limit=nb_limit, source_root=source_dir, imports_root=import_dir, logger=logger)
