# utils/madmom_sav.py
"""
Helpers pour gérer les JSON Madmom (SAV) :
...
def load_madmom_json(
    json_path: Path,
    logger: LoggerProtocol | None = None,
) -> dict[str, JSONValue] | None:
    """
    Charge un JSON Madmom (objet) en dict[str, JSONValue].
    ...
    try:
        ...
        log.exception("Lecture JSON Madmom échouée (%s): %s", json_path, exc)
        return None
