...
@safe_main
def main(nb_limit="0", track_id=None):
    generate_transpositions(nb_limit=nb_limit, track_id=track_id, logger=logger)
...
if __name__ == "__main__":
    ...
    main(nb_limit=args.nb_limit, track_id=args.track_id)
