...
from logic_imports.beets_log_parser import parse_beets_log  # ton parser déjà fourni plus haut
from logic_imports.path_resolve import resolve_album_path_and_rel  # helpers robustes
